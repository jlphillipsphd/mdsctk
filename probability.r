...
if (length(myargs) != 3 & length(myargs) != 4) {
  cat("\n")
  cat("Usage: probability.r [distances.dat] [n] [k] <sigma>\n")
  cat("   Computes the probability density estimate for the\n")
...
write(prob.pointwise(data,sigma),file=stdout(),ncolumns=1)
