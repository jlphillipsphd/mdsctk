...
matplot(as.double(row.names(unsmoothed)),unsmoothed,type='o',
        ...
        xaxt="n")
legend("topright",names(unsmoothed),lty=seq(1,ncol(unsmoothed)),lwd=1,cex=0.5,col=seq(1,ncol(unsmoothed)),bg="white",pch=seq(19,24),title=expression(sigma[theta*phi]))
