...
int main(int argc, char* argv[])
{
  ...
  if (argc != 3) {
    ...
    cerr << "   laplacian using ARPACK and a gaussian kernel of" << endl;
    cerr << "   width sigma, where sigma is calculated using the" << endl;
    cerr << "   average k-smallest values in each column." << endl;
    cerr << endl;
    return -1;
  }
