...
parser$add_argument("-o","--output",default="density.dat",
                    help="(Output) Density file [default %(default)s]")
...
write(dens.pointwise(data,sigma),file=myargs$output,ncolumns=1)
